...
# Peach sem estimativa inicial da matriz hessiana da função sendo
# minimizada, e traça o gráfico da convergência da resposta para
# cada um deles.
