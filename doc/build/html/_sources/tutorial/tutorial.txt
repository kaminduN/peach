...
.. toctree::
    ...
    defuzzification.rst
    fuzzy-defuzzy.rst
    simple-controller.rst
    control-surface.rst
    fuzzy-c-means.rst

Tutorials on single and multivariable Optimization:

.. toctree::

    linear-optimization.rst
    derivative-optimization.rst
    multivariate-optimization.rst
    quasi-newton-optimization.rst

Tutorials on Simulated Annealing:

.. toctree::

    simulated-annealing.rst
    custom-neighbor.rst
    binary-simulated-annealing.rst
    binary-objective-function.rst

Tutorials on Particle Swarm Optimization:

.. toctree::

    particle-swarm-optimization.rst

Tutorials on Genetic Algorithms:
